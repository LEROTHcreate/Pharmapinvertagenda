          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="mt-1 flex flex-wrap items-center gap-x-3 gap-y-2">
              <Input
                ...
                maxLength={80}
                className="h-9 w-auto min-w-[150px] max-w-[240px] border-0 border-b border-zinc-200 bg-transparent px-0 text-xl font-bold tracking-tight shadow-none focus-visible:border-violet-500 focus-visible:ring-0 md:text-2xl"
              />
              <input
                type="text"
                value={category}
