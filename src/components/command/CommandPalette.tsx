...
export function CommandPalette({
  ...
  const commands = useMemo<Cmd[]>(() => {
    const all: (Cmd & { show: boolean })[] = [
      ...
      { label: "Bilan & décisions", href: "/bilan", icon: FileSpreadsheet, show: isAdmin, keywords: "bilan comptable financier resultat ratios analyse decision fiscal investissement" },
