...
export function CommandPalette({
  ...
  const commands = useMemo<Cmd[]>(() => {
    const all: (Cmd & { show: boolean })[] = [
      ...
      { label: "Créneaux à couvrir", href: "/creneaux", icon: ClipboardList, show: true, keywords: "trou pourvoir renfort volontaire remplacement se positionner" },
      { label: "Sondages", href: "/sondages", icon: Vote, show: true, keywords: "sondage vote question qui peut venir samedi disponibilite" },
      ...
      { label: "Pilotage RH", href: "/pilotage", icon: TrendingUp, show: canViewPayroll, keywords: "absenteisme heures sup cout tendances tableau de bord rh" },
      { label: "Bilan & décisions", href: "/bilan", icon: FileSpreadsheet, show: canViewPayroll, keywords: "bilan comptable financier resultat ratios analyse decision fiscal investissement" },
