...
export function WelcomeBanner({
  ...
  return (
    <section
      ...
      className="no-print relative rounded-2xl border border-border bg-card md:bg-card/80 md:backdrop-blur-sm px-4 py-3 pr-14 sm:px-5 sm:py-4 sm:pr-16 flex items-center gap-3 sm:gap-4 shadow-[0_1px_2px_rgba(0,0,0,0.02),0_8px_24px_-12px_rgba(0,0,0,0.06)]"
    >
